...
public class EventosMetodos {
    ...
    ArrayList<Evento> eventosCancelados = new ArrayList<>();
        ...
        if (usuariosArray.get(indice).getUsuario().equals(name)) {
            ...
            for (Evento evento : eventos) {
                if (evento.getCodigo().equals(code)) {
                    System.out.println("VERIFICACION: Si existe y es de ese usuario");
                    return true;
                }
            }
        }

        System.out.println("VERIFICACION: Probable no es de ese usuario.");
    ...
    public void EditarEventoReligioso(String codigo, String name, String nuevoTitulo, String nuevaDesc, Date nuevaFecha, double nuevoMonto, int nuevaCantidad) {
        boolean eventoEncontrado = BuscarEvento(name, codigo);
    ...
    public void EditarEventoMusical(String codigo, String name, String nuevoTitulo, String nuevaDesc, Date nuevaFecha, double nuevoMonto, String tipoMusical, int nuevaCantidad) {
        boolean eventoEncontrado = BuscarEvento(name, codigo);
   ...
   boolean eventoEncontrado = BuscarEvento(name, codigo);
                    ...
                    for (Evento evento : eventos) {
                        if (evento.getCodigo().equals(codigo)) {
                            ...
                            if ((today.get(Calendar.DAY_OF_YEAR) == eventDate.get(Calendar.DAY_OF_YEAR) - 1) && !(evento instanceof EventoReligioso)) {
                                double pagoCancelar = evento.getMonto() * 0.5;
    ...
    JOptionPane.showMessageDialog(null, "No se encontró el evento para eliminar.");
